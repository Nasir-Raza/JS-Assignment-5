...
var userName = prompt("Enter username (special characters like [@.,!#&*$%^] not allowed)");
var isValid = true;

for (var i = 0; i < userName.length; i++) {
    if (userName.charCodeAt(i) == 64 || userName.charCodeAt(i) == 46 || userName.charCodeAt(i) == 44 || userName.charCodeAt(i) == 33 || userName.charCodeAt(i) == 35 || userName.charCodeAt(i) == 38 || userName.charCodeAt(i) == 42 || userName.charCodeAt(i) == 36 || userName.charCodeAt(i) == 37 || userName.charCodeAt(i) == 94) {
        isValid = false;
        break;
    }
}
...
if (isValid) {
    str += "<p>You have entered valid username: " + userName + "</p>";
} else {
    alert("The username '" + userName + "' contains special character '" + userName.charAt(i) + "' which is not allowed. Please enter valid username.");
    str += "<p>The username '" + userName + "' contains special character '" + userName.charAt(i) + "' which is not allowed. Please enter valid username.</p>";
}
...
if (userPassword.charCodeAt(0) >= 48 && userPassword.charCodeAt(0) <= 57) {
    ...
    messageStr = "Password can not begin with a number";
} else if (userPassword.length <= 5) {
    isValidPassword = false;
    messageStr = "Password must at least 6 characters long";
} else {
    for (var i = 0; i < userPassword.length; i++) {
        if (userPassword.charCodeAt(i) >= 48 && userPassword.charCodeAt(i) <= 57) {
            isValidPassword = true;
            messageStr = "You have entered valid password";
            break;
        } else {
            isValidPassword = false;
            messageStr = "Password should contain both alphabets and numbers";
        }
    }
}

if (!isValidPassword) {
    str += "<P>Entered password: " + userPassword + "<br/>" + messageStr + "<br/>Please enter a valid password</p>";
} else {
    str += "<P>Entered password: " + userPassword + "<br/>" + messageStr + "</p>";
}
